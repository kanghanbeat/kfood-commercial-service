...
**미반영 개선 포인트(다음 후보, 세션11 훑기 결과):** ③모바일 인기 칩 한 줄 스크롤 ⑥지도 아래 지역 칩 소제목 ⑩"From our channels" 카드에 썸네일 ⑪푸터 브랜드 영역 ⑫모바일 섹션 제목 축소 ⑭"Review photo sources" 버튼 하단 이동. 이후 커뮤니티·마이페이지 UI 개선도 대기.
