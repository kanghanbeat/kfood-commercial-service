...
const en = {
  ...
  home: {
    ...
    mapHint: "Tap a colored province to explore its food areas.",
    eatEyebrow: "Eat",
...
const ko: Dictionary = {
  ...
  home: {
    ...
    mapHint: "색칠된 시·도를 누르면 그 지역의 음식 동네로 이동해요.",
    eatEyebrow: "먹기",
...
const ja: Dictionary = {
  ...
  home: {
    ...
    mapHint: "色のついた地域をタップすると、そのエリアのグルメへ移動します。",
    eatEyebrow: "食べる",
